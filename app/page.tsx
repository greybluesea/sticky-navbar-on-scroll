      ...
      <Container>
        <div className="space-y-10 p-4 sm:p-6 lg:p-8 pb-8 md:pb-18">
          <section
            ...
            className="rounded-lg aspect-square md:aspect-[2.4/1] overflow-hidden bg-cover bg-fixed first-line:marker:h-full w-full flex flex-col justify-center items-center text-center gap-y-8"
          >
